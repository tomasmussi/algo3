...
public class CapturaTest {
	...
	private CaracteristicaLadron caracteristica1;
	private CaracteristicaLadron caracteristica2;
	...
	public void  initialize() {
		caracteristica1 = new CaracteristicaLadron("Nick Brunch", "Masculino", "Mountain Climbing", "Negro", "Anillo", "Motocicleta");
		caracteristica2 = new CaracteristicaLadron("Merey Laroc", "Femenino", "Croquet", "Marron", "Joyas", "Limusina");
		ladron = new Ladron(caracteristica1);
	...
	public void testPoliciaNoAtrapaLadronSinTiempoRestante(){
		...
		assertFalse(policia.emitirOrdenDeArresto(caracteristica1));
	...
	public void testPoliciaNoAtrapaLadronConOrdenDeArrestoEquivocada(){
		...
		assertTrue(policia.emitirOrdenDeArresto(caracteristica2));
	...
	public void testPoliciaAtrapaLadronConTiempoYOrdenDeArrestoCorrecta(){
		...
		assertTrue(policia.emitirOrdenDeArresto(caracteristica1));
